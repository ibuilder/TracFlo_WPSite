 ...
 */
(function() {
    tinymce.PluginManager.add('trac_magic_button', function( editor, url ) {
        editor.addButton( 'trac_magic_button', {
...
(function() {
    tinymce.PluginManager.add('trac_no_wrap', function( editor, url ) {
            editor.addButton( 'trac_no_wrap', {
            title: 'No-Wrap',
			icon: 'nonbreaking',
            onclick: function() {
